# Телеграм бот и бэкенд апи формы для обратной связи компании **МосГорТранс**
___
## Установка
Здесь и далее команды будут только для Linux, операционной системы, используемой почти на всех серверах мира.
___
...
Так же не забудьте настроить веб сервер для связи бэкенда со внешним миром. В случае с nginx, добавьте
```nginx
...
```
в блок с прослушиванием вашего домена
___
### Создание .env файла
...
___
### В случае успеха, в ответ получите 
Response("OK", 200)
### Или
